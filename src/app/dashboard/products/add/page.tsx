...
import { Upload, X, Check, BrainCircuit, ChevronDown, Loader2 } from "lucide-react"
...
import { UpgradeTooltip } from '@/components/dashboard/upgrade-tooltip';
...
export default function AddProductPage() {
  ...
  const { user } = useUser();
  const { business, plan, isBusinessLoading, productCount } = useBusiness();
  ...
  const isLoading = isBusinessLoading || isSaving || areCategoriesLoading;
  ...
  useEffect(() => {
    if (!canAddProduct && !isBusinessLoading) {
      toast({
        variant: "destructive",
  ...
  }, [canAddProduct, isBusinessLoading, router, toast]);
  ...
  const handleSuggestCategories = useCallback(async () => {
    ...
    setSuggestions([]);
    try {
        const { categories: suggested } = await getSuggestedCategories({
        ...
        toast({
            ...
            description: 'Could not generate category suggestions at this time.',
        });
    } finally {
...
const handleGenerateDescription = useCallback(async () => {
  ...
  const handleSave = async () => {
    ...
    try {
        ...
        toast({ title: "Product Saved", description: `"${productName}" has been successfully saved.` });
        router.push('/dashboard/products');

    } catch (error: any) {
        console.error("Error saving product:", error);
        toast({ variant: "destructive", title: "Uh oh! Something went wrong.", description: error.message || "Could not save product. Please try again." });
    } finally {
        setIsSaving(false);
    }
  };
        ...
        <div className="mx-auto grid max-w-[59rem] flex-1 auto-rows-max gap-4">
            <div className="flex items-center gap-4">
                ...
                <div className="hidden items-center gap-2 md:ml-auto md:flex">
                    ...
                    <Button size="sm" onClick={handleSave} disabled={isLoading || !businessId}>
                ...
                <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Add images for your product. The first image will be the main one.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
